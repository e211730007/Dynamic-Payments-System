...
💡 מסקנות עיקריות
המבדק הוכיח כי SQL Stored Procedures הם הפתרון המהיר ביותר לעיבוד מאסיבי של נתונים, בעוד ש-
Python מהירה מאוד בחישוב רשומה בודדת אך פחות יעילה במאסה של מיליון רשומות בשל תקורת קריאות

מכיוון שהקובץ דוח מסכם אינו נפתח תמיד תקין דרך הגיט ניתן להוריד אותו
